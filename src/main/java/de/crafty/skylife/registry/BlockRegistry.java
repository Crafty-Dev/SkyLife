...
public class BlockRegistry {
    ...
    public static final BaseEnergyBlock OIL_PROCESSOR = registerDefault("oil_processor", new OilProcessorBlock(BlockBehaviour.Properties.of().mapColor(MapColor.STONE).requiresCorrectToolForDrops().strength(3.5F).noOcclusion()));

...
public class BlockBreakerScreen extends AbstractEnergyContainerScreen<BlockBreakerMenu> {
    ...
    protected void renderBg(GuiGraphics guiGraphics, float partialTicks, int mouseX, int mouseY) {
        ...
        guiGraphics.blit(RenderType::guiTextured, BLOCK_BREAKER_LOCATION, x, y, 0, 0, this.imageWidth, this.imageHeight, 256, 256);

        if (!this.getMenu().getSlot(0).hasItem())
            guiGraphics.blit(RenderType::guiTextured, BLOCK_BREAKER_LOCATION, x + 80, y + 18, 176, (this.toolAnimTick / 20) * 16, 16, 16, 256, 256);

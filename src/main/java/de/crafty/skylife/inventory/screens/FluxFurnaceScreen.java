...
public class FluxFurnaceScreen extends AbstractEnergyContainerScreen<FluxFurnaceMenu> {
    ...
    protected void renderBg(GuiGraphics guiGraphics, float partialTicks, int mouseX, int mouseY) {
        ...
        guiGraphics.blit(FLUX_FURNACE_LOCATION, x, y, 0, 0, this.imageWidth, this.imageHeight);
        ...
        if (this.getMenu().hasPerformanceMode()) {
            guiGraphics.blit(FLUX_FURNACE_LOCATION, x + 7, y + 12, 176, 60, 8, 62);
            guiGraphics.blit(FLUX_FURNACE_LOCATION, x + 161, y + 12, 176, 60, 8, 62);

            guiGraphics.blit(FLUX_FURNACE_LOCATION, x + 8, y + 13 + (60 - Math.round(60 * progress)), 176, 0, 6, Math.round(60 * progress));
            guiGraphics.blit(FLUX_FURNACE_LOCATION, x + 162, y + 13 + (60 - Math.round(60 * progress)), 176, 0, 6, Math.round(60 * progress));
        }

        guiGraphics.blit(FLUX_FURNACE_LOCATION, x + 72, y + 35, 182, this.getMenu().hasPerformanceMode() ? 16 : 0, Math.round(22 * progress), 15);
